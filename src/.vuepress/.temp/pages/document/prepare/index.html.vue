...
<figure><img src="@source/document/prepare/image.png" alt="源代码管理面板" width="300" height="500" tabindex="0" loading="lazy"><figcaption>源代码管理面板</figcaption></figure>
<ol start="2">
...
<figure><img src="@source/document/prepare/image-1.png" alt="输入存储库地址" width="650" height="150" tabindex="0" loading="lazy"><figcaption>输入存储库地址</figcaption></figure>
<ol start="3">
<li>
<p>选择一个文件夹作为存储库。</p>
</li>
...
<figure><img src="@source/document/prepare/image-2.png" alt="目录" width="200" height="250" tabindex="0" loading="lazy"><figcaption>目录</figcaption></figure>
<h2 id="文件结构" tabindex="-1"><a class="header-anchor" href="#文件结构" aria-hidden="true">#</a> 文件结构</h2>
